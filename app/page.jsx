...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>ReelSavvy</title>
        <meta name='description' content='One stop for all your movie needs.' />
      </Head>
      <main
        className={`snap-y snap-mandatory w-full h-screen overflow-y-scroll bg-black text-white p-5 md:p-10 ${dmSans.className}`}>
        <div className='bg-black z-3 absolute top-0 left-0 right-0 w-full p-5 md:p-10 flex items-center justify-center'>
